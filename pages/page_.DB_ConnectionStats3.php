...
function echoMainFrame(){
    ...
    echo sprintf('<a href="shell.DB_ConnectionStats_clear.php" target="frame_blind1">Purge data</a><br />');
    echo sprintf('<a href="shell.DB_ConnectionStatsUpdate.php" target="frame_blind2">Update data</a><br />');
    //echo '<br />';
